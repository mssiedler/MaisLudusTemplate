...
namespace Tests
{
    public class ExpectedSettings
    {
        ...
        [Test]
        public void Graphics_IsLinearColorSpace()
        {
            Assert.That(QualitySettings.activeColorSpace, Is.EqualTo(ColorSpace.Linear), "QualitySettings.activeColorSpace should be Linear by default.");
        }
        ...
        [Test]
        public void EditorSettings_SpritePackingMode()
        {
            Assert.That(EditorSettings.spritePackerMode, Is.EqualTo(SpritePackerMode.SpriteAtlasV2), "EditorSettings.spritePackerMode should be SpritePackerMode.SpriteAtlasV2 by default.");
        }
